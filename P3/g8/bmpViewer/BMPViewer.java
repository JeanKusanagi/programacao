...
public final class BMPViewer extends JFrame implements ActionListener {
	...
	public BMPViewer() {
		...
		System.out.println("Elapsed Time: " + ((finalTime - initialTime)/(10^3)));
	...
	private void createPanelImage() {
		...
		// JPanel panel = new PanelImage(bmp.getPixelData(), bmp.getWidth(), bmp.getHeight());
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (e.getSource() == openButton) {
			...
			if (returnVal == JFileChooser.APPROVE_OPTION) {
				...
				// TODO do something with the opened file
			} else {
